...
class SwinTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        nums_x[0] = self.contra(nums_x[0])
        nums_x[0] = self.norm_0(nums_x[0])

        nums_x[1] = self.contra(nums_x[1])
        nums_x[1] = self.norm_1(nums_x[1])

        nums_x[2] = self.contra(nums_x[2])
        nums_x[2] = self.norm_2(nums_x[2])

        nums_x[3] = self.contra(nums_x[3])
